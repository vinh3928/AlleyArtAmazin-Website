	...
	<div class="portfolioContainer">
		<?php while ( have_posts() ) : the_post(); ?>
			<?php
				//$portfolio_cats = '';
				/*echo get_the_ID();*/
				$portfolio_cats = get_the_terms( get_the_ID(), 'project-category');
				$project_css 	= 'portfolio-sample animated';
				foreach ( $portfolio_cats as $category ) {
					$project_css .= ' '. $category->slug;
				}
			?>
			<div id="post-<?php the_ID(); ?>" <?php post_class( $project_css ); ?> data-animation="fadeIn">
				<figure>
					<?php 
