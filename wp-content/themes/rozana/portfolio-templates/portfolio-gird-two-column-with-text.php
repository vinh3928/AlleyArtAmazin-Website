...
<?php } ?>
<div class="portfolioContainer portfolio-withtext-gird">
	<?php while ( have_posts() ) : the_post(); ?>
		...
		?>
		<div class="col-md-6 col-sm-6 col-xs-6<?php echo esc_attr( $project_css ); ?>">
			<div class="portfolio-sample animated" data-animation="fadeIn">
				<figure>
					<?php 
