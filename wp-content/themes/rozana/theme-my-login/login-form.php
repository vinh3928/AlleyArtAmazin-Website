...
*/
?>
<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 text-center login-icon">
	<h2>- <?php _e('Login to continue', 'samathemes'); ?> -</h2>
	<div class="login" id="theme-my-login<?php $template->the_instance(); ?>">
		...
		<form name="loginform" id="loginform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'login' ); ?>" method="post">
				...
				<input type="password" name="pwd" id="user_pass<?php $template->the_instance(); ?>" class="input" value="" size="20" placeholder="<?php _e('Password','samathemes'); ?>" />
